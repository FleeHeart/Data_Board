...
public class AdCampaign {
     ...
     */
    public AdCampaign(String date, double cost, int leadCount, int messageCount) {
        this.date = date;
        this.cost = cost;
     ...
     */
    public String analyzeCostChange(AdCampaign previousCampaign) {
        // 检查是否有历史数据可供比较
     ...
     * @return 变动情况描述，包含变动金额和百分比
     */
    public String analyzeCostPerLeadChange(AdCampaign previousCampaign) {
        if (previousCampaign == null) return "无历史数据可供比较";
     ...
     * @return 变动情况描述，包含变动金额和百分比
     */
    public String analyzeMessageCostChange(AdCampaign previousCampaign) {
        if (previousCampaign == null) return "无历史数据可供比较";
